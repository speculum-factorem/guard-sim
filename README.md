...
Материалы и интерфейсы предназначены для **учебной симуляции**. Не используйте проект как готовое решение для реальной классификации угроз или юридических/комплаенс-выводов без независимой экспертизы.

---

Если нужно доработать документ (например, добавить схему БД, политику релизов или CI), это можно вынести в отдельные файлы в `docs/` по мере роста проекта.
